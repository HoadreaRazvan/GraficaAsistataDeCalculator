...
void CALLBACK RotateXDown()
{
    x = x - 10;
}

void CALLBACK RotateXUp()
{
    x = x + 10;
}

void CALLBACK RotateYDown()
{
    y = y - 10;
}

void CALLBACK RotateYUp()
{
    y = y + 10;
}
...
int main(int argc, char** argv)
{
    ...
    auxKeyFunc(AUX_LEFT, RotateXUp);
    auxKeyFunc(AUX_RIGHT, RotateXDown);
    auxKeyFunc(AUX_DOWN, RotateYUp);
    auxKeyFunc(AUX_UP, RotateYDown);
